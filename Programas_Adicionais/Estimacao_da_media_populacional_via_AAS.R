...
setwd("C:\\Users\\Alexandre\\Dropbox\\Novos_cursos\\ENAP_Introducao_a_Inferencia\\ProgramasR\\Dados_Municipios");
...
for (k in n_amostras)
{
    ...
    print(paste0("Número de observaçoes na amostra: ", as.character(k)))
    print(paste0("Coeficiente de assimetria: ", as.character(skewness(medias_simulacoes1))))
    print(paste0("Kurtose: ", as.character(kurtosis(medias_simulacoes1))))
    print(" ")
